...
def main():
    cleaned = pd.read_csv('../model_inputs/cleaned_maccs.csv', sep = '\t', index_col = 0)
    physchem_samples = cleaned.index.tolist()
    rf_hyperparams = []
            ...
            for content in os.listdir(input_directory):
                ...
                for model_name in ['rf']:
                    ...
                    for fold in range(5):
                        ...
                        if not (model_name == 'tabpfn'):
                            ...
                            for combi in hyperparameters[model_name]:
                                ...
                                for ht_fold in range(4):
                                    ...
                                    training_samples = f'{path_to_CV_folds}/fold{fold}/hyperparameter_tuning/fold{ht_fold}/train_cleaned.txt'
                                    test_samples = f'{path_to_CV_folds}/fold{fold}/hyperparameter_tuning/fold{ht_fold}/test_cleaned.txt'
                        ...
                        training_samples = f'{path_to_CV_folds}/fold{fold}/train_cleaned.txt'
                        test_samples = f'{path_to_CV_folds}/fold{fold}/test_cleaned.txt'
                        ...
                        config_file_path = f'{output_dir}/{dr_name}_{feature_type}_{model_name}_cleaned_config.json'
                        subprocess.run(args=['bash', json_config_gen,
                                             model_name, training_samples, test_samples, features, output_dir, 'deterministic', model_specific, task, analysis_name, config_file_path])
                        ...
                        with open(f'{output_final_results}/fold{fold}/final_models_{feature_type}_{dr_name}_cleaned.txt', 'a') as output:
                            output.write(
