...
def main(feature_type):
    files = {'physchem': '../model_inputs/physchem_properties.csv',
             'maccs': '../model_inputs//maccs_physchem_samples.csv', 'morgan': '../model_inputs/morgan_physchem_samples.csv'}
            ...
            for content in os.listdir(directory):
                ...
                for model_name in ['rf']:
                    ...
                    for fold in range(5):
                        ...
                        if not (model_name == 'tabpfn'):
                            ...
                            for combi in hyperparameters[model_name]:
                                ...
                                for ht_fold in range(4):
                                    ...
                                    config_file_path = f'{output_dir}/{dr_name}_{model_name}_{feature_type}_physchem_samples_config.json'
                        ...
                        with open(f'{output_dir_final_results}/final_models_{feature_type}_{dr_name}_physchem_samples.txt', 'a') as output:
                            output.write(
