    ...
    for dr_name in ['none']:
        ...
        for subfolder in subfolders:
            ...
            for content in os.listdir(input_directory):
                if '.csv' in content:
                    continue
                with open('/local/lisa-marie.rolli/comptox_benchmark/already_done_embeddings_none.txt', 'r') as assay_file:
                    assays = assay_file.read().splitlines()
                if content in assays:
                    continue
                print(content)
