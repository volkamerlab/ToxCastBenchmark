...
def main():
    ...
    for assay_filname in assay_filenames:
        ...
        if match:
            ...
            if assay_name in completed_assays:
                continue
        try:
        ...
        for f in range(5):
            os.makedirs(
                f'/home/lisa-marie-rolli/comptox_benchmark/ToxCast_Assays_Endpoint_Results/{subfolder}//{assay_name}//fold{f}/', exist_ok=True)
            with open(f'/home/lisa-marie-rolli/comptox_benchmark/ToxCast_Assays_Endpoint_Results/{subfolder}//{assay_name}//fold{f}/train.txt', 'w') as train:
                with open(f'/home/lisa-marie-rolli/comptox_benchmark/ToxCast_Assays_Endpoint_Results/{subfolder}//{assay_name}//fold{f}/test.txt', 'w') as test:
            ...
            for ht_fold in range(5):
                if ht_fold == f:
                    continue
                os.makedirs(
                    f'/home/lisa-marie-rolli/comptox_benchmark/ToxCast_Assays_Endpoint_Results/{subfolder}//{assay_name}//fold{f}/hyperparameter_tuning/fold{ht_fold_index}/', exist_ok=True)
                with open(f'/home/lisa-marie-rolli/comptox_benchmark/ToxCast_Assays_Endpoint_Results/{subfolder}//{assay_name}//fold{f}/hyperparameter_tuning/fold{ht_fold_index}/train.txt', 'w') as train:
                    with open(f'/home/lisa-marie-rolli/comptox_benchmark/ToxCast_Assays_Endpoint_Results/{subfolder}//{assay_name}//fold{f}/hyperparameter_tuning/fold{ht_fold_index}/test.txt', 'w') as test:
                        for compound in res.keys():
                            fold = res[compound]
                            if fold == f'fold{ht_fold}':
                                ...
                                train.write(f'{compound}\n')
                ht_fold_index += 1
        with open('/home/lisa-marie-rolli/comptox_benchmark/data_processing/considered_hormone_assay_names.txt', 'a') as assays_done:
            assays_done.write(f'{assay_name}\n')
        with open('/home/lisa-marie-rolli/comptox_benchmark/data_processing/considered_hormone_assays_epsilon_and_delta03.txt', 'a') as only_feasible_now:
